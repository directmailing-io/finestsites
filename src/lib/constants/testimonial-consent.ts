...
export const TESTIMONIAL_CONSENT_CURRENT_VERSION = 'tv2'
...
Diese Einwilligung gebe ich freiwillig ab. Die Inhalte stammen von mir und ich habe die Rechte an allen hochgeladenen Fotos und Videos.`,
  ...
  // tv2: wie tv1, nur Widerrufs-Adresse korrigiert (hello@ → info@finestsites.io)
  tv2: `Ich bin damit einverstanden, dass FinestSites meinen Erfahrungsbericht (Text, Fotos, Video, Audio) zusammen mit meinem Namen in der von mir gewählten Darstellung veröffentlicht. Konkret heißt das:
...
4. Widerruf: Ich kann diese Einwilligung jederzeit ohne Angabe von Gründen widerrufen. Dafür reicht eine formlose E-Mail an info@finestsites.io. Mein Bericht wird dann zeitnah von allen FinestSites-Seiten entfernt. Die Rechtmäßigkeit der Nutzung bis zum Widerruf bleibt davon unberührt.
