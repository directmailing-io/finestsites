    ...
    <aside
      ...
      <div className="px-3 pb-5 flex flex-col gap-1">
              ...
              <>
                <Link href="/billing"
                  ...
                  <div>
                    ...
                    <p className="text-[10px]" style={{ color: quota.atLimit ? '#DC2626' : '#9CA3AF' }}>
                      {quota.atLimit ? 'Limit erreicht' : `${quota.used} / ${quota.limit} Webseiten`}
                    </p>
                  </div>
                  {quota.atLimit && (
        ...
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm w-full text-left transition-colors hover:bg-red-50"
          style={{ color: '#9CA3AF' }}
